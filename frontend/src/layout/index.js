        ...
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          >
            {greaterThenSm && user?.profile === "admin" && user?.company?.dueDate ? (
              <>
                Olá <b>{user.name}</b>, Seja Bem-Vindo(a) à Plataforma <b>DR MULTICHATBOT</b>! (Plano Ativo até {dateToClient(user?.company?.dueDate)})
              </>
            ) : (
              <>
                Olá <b>{user.name}</b>, Seja Bem-vindo(a) à Plataforma <b>DR MULTICHATBOT</b>!
              </>
            )}
          </Typography>
