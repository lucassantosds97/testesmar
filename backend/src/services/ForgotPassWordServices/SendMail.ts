    ...
    async function sendEmail() {
      try {
        const mailOptions = {
          from: fromEmail,
          to: email,
          subject: "Redefinição de Senha - 𝐃𝐑𝐌𝐔𝐋𝐓𝐈𝐂𝐇𝐀𝐓𝐁𝐎𝐓",
          text: `Olá,\n\nVocê solicitou a redefinição de senha para sua conta na 𝐃𝐑𝐌𝐔𝐋𝐓𝐈𝐂𝐇𝐀𝐓𝐁𝐎𝐓. Utilize o seguinte Código de Verificação para concluir o processo de redefinição de senha:\n\nCódigo de Verificação: ${tokenSenha}\n\nPor favor, copie e cole o Código de Verificação no campo 'Código de Verificação' na plataforma 𝐃𝐑𝐌𝐔𝐋𝐓𝐈𝐂𝐇𝐀𝐓𝐁𝐎𝐓.\n\nSe você não solicitou esta redefinição de senha, por favor, ignore este e-mail.\n\n\nAtenciosamente,\nEquipe 𝐃𝐑𝐌𝐔𝐋𝐓𝐈𝐂𝐇𝐀𝐓𝐁𝐎𝐓`
        };
